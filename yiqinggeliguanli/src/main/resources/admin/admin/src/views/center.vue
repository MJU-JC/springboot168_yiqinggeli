<template>
  <div>
    ...
    >  
     <el-row>
                    <el-col :span="12">
           <el-form-item v-if="flag=='gongyingshang'"  label='供应商名称' prop="gongyingshangName">
               <el-input v-model="ruleForm.gongyingshangName"  placeholder='供应商名称' clearable></el-input>
           </el-form-item>
         </el-col>

         <el-col :span="12">
           <el-form-item v-if="flag=='gongyingshang'"  label='供应商地址' prop="gongyingshangAddress">
               <el-input v-model="ruleForm.gongyingshangAddress"  placeholder='供应商地址' clearable></el-input>
           </el-form-item>
         </el-col>

         <el-col :span="24">
             <el-form-item v-if="flag=='gongyingshang'"  label="供应商介绍" prop="diquContent">
                 <editor
...
export default {
  ...
  methods: {
    ...
    onUpdateHandler() {
                         ...
                         if((!this.ruleForm.gongyingshangAddress)&& 'gongyingshang'==this.flag){
                             this.$message.error('供应商地址不能为空');
                             return
                         }

                         if((!this.ruleForm.diquContent)&& 'gongyingshang'==this.flag){
                             this.$message.error('供应商介绍不能为空');
                             return
                         }
