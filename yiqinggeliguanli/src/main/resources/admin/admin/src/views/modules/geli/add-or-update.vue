    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="隔离类型" prop="geliTypes">
                        <el-select v-model="ruleForm.geliTypes" :disabled="ro.geliTypes" placeholder="请选择隔离类型">
                            <el-option
                    ...
                    <div v-else>
                        <el-form-item class="input" label="隔离类型" prop="geliValue">
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="隔离备注" prop="geliContent">
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.geliContent" label="隔离备注" prop="geliContent">
