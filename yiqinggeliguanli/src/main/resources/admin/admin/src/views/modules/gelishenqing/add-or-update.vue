    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="隔离结束申请内容" prop="gelishenqingContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                                v-model="ruleForm.gelishenqingContent"
                                class="editor"
                                action="file/upload">
                        </editor>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.gelishenqingContent" label="隔离结束申请内容" prop="gelishenqingContent">
                            <span v-html="ruleForm.gelishenqingContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
    ...
    export default {
        data() {
            return {
                ...
                ro:{
                    yonghuId: false,
                    gelishenqingContent: false,
                    gelishenqingYesnoTypes: false,
                    gelishenqingYesnoText: false,
                    insertTime: false,
                },
                ruleForm: {
                    yonghuId: '',
                    gelishenqingContent: '',
                    gelishenqingYesnoTypes: '',
                    gelishenqingYesnoText: '',
                    insertTime: '',
                },
                gelishenqingYesnoTypesOptions : [],
                yonghuOptions : [],
                rules: {
                   yonghuId: [
                   ...
                   gelishenqingContent: [
                              { required: true, message: '隔离结束申请内容不能为空', trigger: 'blur' },
                          ],
                   gelishenqingYesnoTypes: [
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=gelishenqing_yesno_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.gelishenqingYesnoTypesOptions = data.data.list;
                    }
                });
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`gelishenqing/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.gelishenqingCrossAddOrUpdateFlag = false;
                                        this.parent.search();
