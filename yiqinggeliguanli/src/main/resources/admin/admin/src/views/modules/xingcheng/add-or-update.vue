    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
                ...
                <el-col :span="12"  v-if="sessionTable !='diqu' ">
                    <el-form-item class="input" v-if="type!='info'"  label="风险等级" prop="diquValue">
                        <el-input v-model="diquForm.diquValue"
                                  placeholder="风险等级" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="风险等级" prop="diquValue">
            ...
            <input id="diquId" name="diquId" type="hidden">
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="行程备注" prop="xingchengContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                                v-model="ruleForm.xingchengContent"
                                class="editor"
                                action="file/upload">
                        </editor>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.xingchengContent" label="行程备注" prop="xingchengContent">
                            <span v-html="ruleForm.xingchengContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  class="input" label="经过时间" prop="jingguoTime">
                        <el-date-picker
                                value-format="yyyy-MM-dd HH:mm:ss"
                                v-model="ruleForm.jingguoTime"
                                type="datetime"
                                placeholder="经过时间"
                                :disabled="ro.jingguoTime">
                        </el-date-picker>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.jingguoTime" label="经过时间" prop="jingguoTime">
                            <span v-html="ruleForm.jingguoTime"></span>
                        </el-form-item>
                    </div>
                </el-col>
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   xingchengContent: [
                              { required: true, message: '行程备注不能为空', trigger: 'blur' },
                          ],
                   jingguoTime: [
                              { required: true, message: '经过时间不能为空', trigger: 'blur' },
                          ],
                   insertTime: [
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`xingcheng/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.xingchengCrossAddOrUpdateFlag = false;
                                        this.parent.search();
